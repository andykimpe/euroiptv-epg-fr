...
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="CinecinemaClassic.fr">
    <display-name lang="fr">|FR| Cine+ Classic</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/cineplusclassic.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
cat $wwwdir/xmltv/France/CinePlusClassic/CinePlusClassic.xml >> $wwwdir/xmltv/guide.xml
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="OrangeCinemax.fr">
    <display-name lang="fr">|FR| OCS Max</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/ocsmax.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
cat $wwwdir/xmltv/France/OCSMax/OCSMax.xml >> $wwwdir/xmltv/guide.xml
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="OrangeCineHappy.fr">
    <display-name lang="fr">|FR| OCS City</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/ocscity.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
cat $wwwdir/xmltv/France/OCSCity/OCSCity.xml >> $wwwdir/xmltv/guide.xml
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="OrangeCinechoc.fr">
    <display-name lang="fr">|FR| OCS Choc</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/ocschoc.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
...
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="TCM.fr">
    <display-name lang="fr">|FR| TCM Cinema</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/tcmcinema.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
cat $wwwdir/xmltv/France/TCMCinema/TCMCinema.xml >> $wwwdir/xmltv/guide.xml
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="ParamountChannelDecale.fr">
    <display-name lang="fr">|FR| Paramount Channel Decale</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/paramountchanneldecale.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
...
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="Action.fr">
    <display-name lang="fr">|FR| Action</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/action.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
cat $wwwdir/xmltv/France/Action/Action.xml >> $wwwdir/xmltv/guide.xml
cat >> $wwwdir/xmltv/guide.xml <<EOF
  <channel id="AlticeStudio.fr">
    <display-name lang="fr">|FR| Altice Studio</display-name>
    <icon src="https://raw.githubusercontent.com/andykimpe/euroiptv-epg-fr/master/logo/France/alticestudio.png" />
    <url>https://github.com/andykimpe/euroiptv-epg-fr</url>
  </channel>
EOF
cat $wwwdir/xmltv/France/AlticeStudio/AlticeStudio.xml >> $wwwdir/xmltv/guide.xml
