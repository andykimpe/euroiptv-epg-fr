...
if [ -f "/usr/bin/mono" ]; then
    mono $wwwdir/xmltv/France/Multisports1/bin/WebGrab+Plus.exe $wwwdir/xmltv/France/Multisports1
else
$wwwdir/xmltv/France/Multisports1/bin/WebGrab+Plus.exe $wwwdir/xmltv/France/Multisports1
fi
