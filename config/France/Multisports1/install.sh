...
wget https://github.com/andykimpe/euroiptv-epg-fr/raw/master/config/France/Multisports1/$crondir/Multisports1 -O /etc/cron.d/Multisports1
chmod 644 /etc/cron.d/Multisports1
$wwwdir/xmltv/France/Multisports1/Multisports1.sh
