...
wget --no-check-certificate https://github.com/andykimpe/euroiptv-epg-fr/raw/master/config/France/C8/C8.sh -O /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/C8/C8.sh
chmod +x /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/C8/C8.sh
if ! grep -q "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/C8/C8.sh" /etc/crontab; then
    echo "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/C8/C8.sh" >> /etc/crontab;
fi
/home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/C8/C8.sh
