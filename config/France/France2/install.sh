...
wget --no-check-certificate https://github.com/andykimpe/euroiptv-epg-fr/raw/master/config/France/France2/France2.sh -O /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/France2/France.sh
chmod +x /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/France2/France.sh
if ! grep -q "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/France2/France.sh" /etc/crontab; then
    echo "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/France2/France.sh" >> /etc/crontab;
fi
