...
if [ -f "/usr/bin/mono" ]; then
    mono $wwwdir/xmltv/France/Multisports4/bin/WebGrab+Plus.exe $wwwdir/xmltv/France/Multisports4
else
$wwwdir/xmltv/France/Multisports4/bin/WebGrab+Plus.exe $wwwdir/xmltv/France/Multisports4
fi
