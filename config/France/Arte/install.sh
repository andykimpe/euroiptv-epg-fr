...
wget --no-check-certificate https://github.com/andykimpe/euroiptv-epg-fr/raw/master/config/France/Arte/Arte.sh -O /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/Arte/Arte.sh
chmod +x /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/Arte/Arte.sh
if ! grep -q "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/Arte/Arte.sh" /etc/crontab; then
    echo "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/Arte/Arte.sh" >> /etc/crontab;
fi
/home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/Arte/Arte.sh
