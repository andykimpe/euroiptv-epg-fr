...
wget --no-check-certificate https://github.com/andykimpe/euroiptv-epg-fr/raw/master/config/France/RMCDecouverte/RMCDecouverte.sh -O /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/RMCDecouverte/RMCDecouverte.sh
chmod +x /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/RMCDecouverte/RMCDecouverte.sh
if ! grep -q "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/RMCDecouverte/RMCDecouverte.sh" /etc/crontab; then
    echo "00 05 * * * root /bin/bash /home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/RMCDecouverte/RMCDecouverte.sh" >> /etc/crontab;
fi
/home/xtreamcodes/iptv_xtream_codes/wwwdir/xmltv/France/RMCDecouverte/RMCDecouverte.sh
